...
<main>
        <div class="container ">
            ...
            <br><br>
            <!--Form with header-->
                <form  method="POST"  enctype="multipart/form-data" action="<?php echo site_url('Admin/upload/'.$tit);?>">
                    <div class="card">
                        <div class="card-block">
                            ...
                            <input type="file" name="userFile" placeholder="" value="<?php echo set_value('nmdp');?>" id="form2" class="form-control" required>
